...
public class BookService {
	...
	static {
		Book book1 = new Book("Anna Karenina", "BASGA15-252S38", 568, 1872, "Leon Tolstoi","detail 1");
		Book book2 = new Book("To The LightHouse", "BSDGA15-278912", 356, 1926, "Virginia Wolf","detail 2");
		Book book3 = new Book("War and Peace", "BAgyg15-250092", 528, 1872, "Leon Tolstoi","detail 3");
		Book book4 = new Book("Orlando", "yuplA15-340112", 356, 1926, "Virginia Wolf","detail 4");
		Book book5 = new Book("Programming", "RETEWRT-340112", 356, 1926, "Engelbert","detail 5");
		Book book6 = new Book("Programming api rest", "456-HDS-01246", 356, 1926, "Boris Omar","detail 6");
		books.add(book1);
		books.add(book2);
		books.add(book3);
		books.add(book4);
	 ...
	 * 
	 * int i = 0; Faker newfakebook = new Faker();
	 * 
	 * while (i < 10000) {
	 * 
	 * String author = newfakebook.book().author(); String genre =
	 * newfakebook.book().genre(); String title = newfakebook.book().title();
	 * 
	 * fakebooks.add(new Book(title, genre, getRandomNumber(100, 1250),
	 * getRandomNumber(1800, 2021), author)); i++; }
	 * 
	 * return fakebooks; }
	 */
	...
	public Book detailBook(String title){
		 ...
		 Book bookToReturn = this.book;
			
		 for (Book bookInArray : this.books) {
				if(bookInArray.getTitle().equals(title)) {
					bookToReturn = bookInArray;
				}
			}	
			return bookToReturn;
		}
		...
		/*
		 * public int getRandomNumber(int min, int max) { return (int) ((Math.random() *
		 * (max - min)) + min); }
		 */
